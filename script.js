...
if (localStorage.getItem("favourites")==null) {
  ...
  // function for adding id value in local storage favourites 
  function addFavourite(id) {
    if (!arr.includes(id) == true) {
      arr.push(id);
      localStorage.setItem("favourites", JSON.stringify(arr));
      showNotification('Hero added to your favourites');
    }else{
      showNotification('your hero already added in favourites');
    }
  }
    ...
    fetch(
      ...
      .then((data) => {
        ...
        if (data.results) {
            ...
            html += `
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <span><i id="${element.id}" class="fa-solid fa-heart icon" onclick="addFavourite(${element.id})"></i></span>
                </div>
              </div>
                  `;
          });
          ...
          html += `
          <div cnlass="page-wrap d-flex flex-row alig-items-center">
          <div class="container">
